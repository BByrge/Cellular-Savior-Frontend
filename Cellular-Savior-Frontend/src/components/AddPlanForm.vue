            ...
            <div class="bg-white px-6 py-8 mb-4 shadow-md rounded-md border m-4 md:m-0">
                <form @submit.prevent="handleSubmit">
                    ...
                    <div class="mb-4">
                        ...
                        <input v-model="form.carrier" class="border rounded w-full py-2 px-3" id="carrier" type="text" placeholder="Carrier" required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input v-model="form.name" class="border rounded w-full py-2 px-3" id="name" type="text" placeholder="Plan Name" required>
                    </div>

                    <!-- Data -->
                    <div class="mb-4">
                        <label for="data" class="block text-gray-700 font-bold mb-2">Data</label>
                        <input v-model="form.data" id="data" name="data" class="border rounded w-full py-2 px-3" required>
                    </div>

                    <!-- Talk -->
                    <div class="mb-4">
                        <label for="talk" class="block text-gray-700 font-bold mb-2">Talk</label>
                        <input v-model="form.talk" id="talk" name="talk" class="border rounded w-full py-2 px-3" required>
                    </div>

                    <!-- Text -->
                    <div class="mb-4">
                        <label for="text" class="block text-gray-700 font-bold mb-2">Text</label>
                        <input v-model="form.text" id="text" name="text" class="border rounded w-full py-2 px-3" required>
                    </div>

                    <!-- Hotspot -->
                    <div class="mb-4">
                        <label for="hotspot" class="block text-gray-700 font-bold mb-2">Hotspot</label>
                        <input v-model="form.hotspot" id="hotspot" name="hotspot" class="border rounded w-full py-2 px-3" required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input v-model="form.price" id="price" name="price" class="border rounded w-full py-2 px-3" required>
                    </div>

                    <!-- Payoff Deal -->
                    <div class="mb-4">
                        <label for="payoff_deal" class="block text-gray-700 font-bold mb-2">Payoff Deal</label>
                        <input v-model="form.payoff_deal" type="checkbox" id="payoff_deal" name="payoff_deal" class="border rounded py-2 px-3" />
                    </div>

                    <!-- MVNO -->
                    <div class="mb-4">
                        <label for="mvno" class="block text-gray-700 font-bold mb-2">MVNO</label>
                        <input v-model="form.mvno" type="checkbox" id="mvno" name="mvno" class="border rounded py-2 px-3" />
                    </div>

                    <!-- Prepaid -->
                    <div class="mb-4">
                        <label for="prepaid" class="block text-gray-700 font-bold mb-2">Prepaid</label>
                        <input v-model="form.prepaid" type="checkbox" id="prepaid" name="prepaid" class="border rounded py-2 px-3" />   
                    </div>

                    <!-- Tax Inclusive -->
                    <div class="mb-4">
                        <label for="tax_inclusive" class="block text-gray-700 font-bold mb-2">Tax Inclusive</label>
                        <input v-model="form.tax_inclusive" type="checkbox" id="tax_inclusive" name="tax_inclusive" class="border rounded py-2 px-3" />
                    </div>

                    <!-- Description -->
                    <div class="mb-4">
                        <label for="description" class="block text-gray-700 font-bold mb-2">Description</label>
                        <textarea v-model="form.description" id="description" name="description" class="border rounded w-full py-2 px-3" required></textarea>
                    </div>
